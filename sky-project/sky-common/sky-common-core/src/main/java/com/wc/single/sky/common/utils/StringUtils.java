package com.wc.single.sky.common.utils;
...
import com.wc.single.sky.common.core.text.StrFormatter;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils
{
    ...
    /**
     *  驼峰转下划线 userName -> User Name
     * @param str userName
     * @return
     */
    public static String humpToLabel(String str) {
        StringBuilder strLabel = new StringBuilder();
        for (int i = 0; i < str.length(); i++) {
            if (0==i){
                strLabel = new StringBuilder(String.valueOf(str.charAt(i)).toUpperCase());
            }else{
                if (Character.isUpperCase(str.charAt(i))){
                    strLabel.append(" ").append(str.charAt(i));
                }else{
                    strLabel.append(str.charAt(i));
                }
            }
        }
    ...
    /**
     *  驼峰转下划线 user_name -> User Name
     * @param str userName
     * @return
     */
    public static String underlineToLabel(String str) {
        if (StringUtils.isEmpty(str)){
            return null;
        }
        return humpToLabel(toCamelCase(str));
    }
