package com.wc.single.sky.common.utils.file;

import com.wc.single.sky.common.exception.QdpException;
import com.wc.single.sky.common.constant.Constants;
import com.wc.single.sky.common.exception.file.FileNameLengthLimitExceededException;
import com.wc.single.sky.common.exception.file.FileSizeLimitExceededException;
import com.wc.single.sky.common.exception.file.InvalidExtensionException;
import com.wc.single.sky.common.utils.DateUtils;
import com.wc.single.sky.common.utils.StringUtils;
import com.wc.single.sky.common.utils.security.Md5Utils;
...
public class FileUploadUtils
{
    ...
    public static MultipartFile toMultipartFile(String fieldName, File file)  {
        ...
        try (
            ...
            throw new QdpException("Upload file to MultipartFile error:{}",e);
        }
