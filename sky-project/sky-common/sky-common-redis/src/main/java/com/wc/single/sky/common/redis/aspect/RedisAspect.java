...
import com.wc.single.sky.common.redis.annotation.RedisCache;
import com.wc.single.sky.common.redis.annotation.RedisEvict;
...
public class RedisAspect
{
     ...
     */
    @Pointcut("@annotation(com.wc.single.sky.common.redis.annotation.RedisCache)")
    public void redisCachePoint() throws UnsupportedOperationException {
    }

    @Pointcut("@annotation(com.wc.single.sky.common.redis.annotation.RedisEvict)")
    public void redisEvictPoint() throws UnsupportedOperationException {
    }

    @After("redisEvictPoint()")
    public void evict(JoinPoint point) throws UnsupportedOperationException {
    ...
    private String parseKey(String key, Method method, Object[] args)
    {
        ...
        int paraNameArrLength = 0;
        if (paraNameArr != null) {
            paraNameArrLength = paraNameArr.length;
        }
        // 使用SPEL进行key的解析
        ...
        // 把方法参数放入SPEL上下文中
        for (int i = 0; i < paraNameArrLength; i++)
        {
